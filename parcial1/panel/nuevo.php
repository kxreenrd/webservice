...
<div class="col-md-3">
<input type="checkbox" id="" name="<?php echo $data[$i]["fullName"]; ?>" value="<?php echo $data[$i]["id"]; ?>">

<label><?php echo($data[$i]["fullName"]) ?>(<?php echo($data[$i]["id"]) ?>)</label>
</div>
...
<div class="row">
	<div class="col-md-12">
		<a href="actualizar.php" ><button id="submit">Guardar</button></a>
	</div>
</div>
